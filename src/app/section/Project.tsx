...
const styles = StyleSheet.create({
    ...
    // width: "100%" + alignSelf: "stretch" 防止被 ScrollContainer 页面容器的
    // alignItems: "center" 收缩为内容宽度（否则内部 width: 100% 会形成循环依赖，
    // 导致 OptionWheel 容器宽度为 0 而被 overflow: hidden 裁剪）。
    safeArea: {
        flex: 1,
        width: "100%",
        alignSelf: "stretch",
    ...
    // width: "100%" 给 OptionWheel 提供明确的宽度参照。
    content: {
        flex: 1,
        width: "100%",
        zIndex: 1,
